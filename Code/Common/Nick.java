...
public enum Nick {
  ...
  Nick(String s, int r){
    ...
    public static Nick[] list = {ABLE, ACCURSED, BAD, BLACK, BOLD, BRAVE, CHASTE, CONQUEROR, CRUEL, DESIRED, DEVIL, DRUNKARD, FAIR, FAT, FORTUNATE, GENEROUS, GENTLE, GLORIOUS, GOOD, HAMMER, HANDSOME, HOLY, HUNTER, ILLUSTRIOUS, IRON, JUST, KIND, LAME, LIBERAL, LION, MAD, MAGNANIMOUS, MAGNIFICENT, PEACEFUL, PIOUS, PRUDENT, QUARRELLER, RED, RIGHTEOUS, SILENT, SIMPLE, SOLDIER, STRICT, STRONG, TALL, SHORT, TERRIBLE, THUNDERBOLT, TROUBADOUR, UNLUCKY, VALIANT, VICTORIOUS, WARLIKE, WELLBELOVED, WHITE, WICKED, WISE, YELLOW};
